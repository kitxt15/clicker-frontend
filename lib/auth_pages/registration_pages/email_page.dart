...
class EmailRegisterPageWidget extends StatelessWidget {
  const EmailRegisterPageWidget({super.key});
                                ...
                                GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                            builder: (context) =>
                                                const LocationRegisterPageWidget()));
                                  },
